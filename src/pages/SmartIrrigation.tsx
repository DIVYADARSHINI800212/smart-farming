    ...
    <div className="space-y-6">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="text-xs font-semibold uppercase tracking-wider text-agri-green bg-agri-green/10 px-2 py-0.5 rounded">
              Closed-Loop Soil Hydrology
            </span>
          </div>
          <h1 className="text-2xl font-extrabold text-agri-dark tracking-tight">Smart Irrigation Control</h1>
          <p className="text-sm text-agri-muted">
            VPD-driven automated irrigation scheduling, real-time solenoid control, and evapotranspiration budgets
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <MetricCard
          ...
          trend={{ value: '28.5% saved', isPositive: true }}
          highlightColor="agri-green"
          subtitle="vs. traditional timer baseline"
        />
        <MetricCard
          title="Active Solenoid Valves"
          value="1"
          unit="/ 4 Zones"
          icon={<Waves className="w-5 h-5 text-teal-600" />}
          highlightColor="deep-green"
          subtitle="Zone 1 running (42 L/min)"
        />
        <MetricCard
          title="Mean Root-Zone Moisture"
          value="38.5%"
          unit=""
          icon={<Gauge className="w-5 h-5 text-emerald-600" />}
          highlightColor="agri-green"
          subtitle="Optimal field capacity band"
        />
        <MetricCard
          title="Next Scheduled Cycle"
          value="06:30 AM"
          unit=""
          icon={<Clock className="w-5 h-5 text-amber-600" />}
          highlightColor="warning-amber"
          subtitle="Zone 2 • ET₀ triggered"
        />
      </div>
