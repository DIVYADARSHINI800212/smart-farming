...
import { AlertTriangle, ArrowRight, CheckCircle2, BellRing } from 'lucide-react';
  ...
  return (
    <Card>
      <CardHeader
        ...
        subtitle="Ranked by edge risk severity & priority"
      ...
      <div className="space-y-3">
        {activeAlerts.map((alert) => (
          ...
          >
            ...
            <h4 className="text-sm font-bold text-dark-forest mt-2">{alert.title}</h4>
